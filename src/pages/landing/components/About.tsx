            ...
            <div className="flex flex-col items-center justify-center max-w-6xl mx-auto px-8 py-20">
                ...
                >
                    ...
                    <div className="flex space-x-3 mt-8">
                        ...
                        >
                            <div className="text-xs font-medium text-white">Returns, Equal Risk</div>
                            <div className="text-center">
                                <div className="text-sm font-semibold text-white">5 Funds</div>
                                <div className="text-white text-lg mt-1">⌄⌄</div>
                            </div>
                        </div>
                        
                        {/* Middle Card - Purple Gradient */}
                        <div 
                            className="rounded-lg p-3 flex flex-col justify-between relative"
                            style={{
                                width: '80px',
                        ...
                        >
                            <div className="text-xs font-medium text-white">All Parameters</div>
                            <div className="text-center">
                                <div className="text-sm font-semibold text-white">20 Funds</div>
                                <div className="text-white text-lg mt-1">⌄⌄</div>
                            </div>
                        </div>
                        
                        {/* Right Card - Lime Green Gradient */}
                        <div 
                            className="rounded-lg p-3 flex flex-col justify-between relative"
                            style={{
                                width: '80px',
                        ...
                        >
                            <div className="text-xs font-medium text-white">Low Risk, Similar Returns</div>
                            <div className="text-center">
                                <div className="text-sm font-semibold text-white">5 Funds</div>
                                <div className="text-white text-lg mt-1">⌄⌄</div>
                            </div>
                ...
                <div 
                    className="text-black relative overflow-hidden flex flex-col items-stretch bg-[#E2E8F0] pt-10"
                    style={{
                        height: '480px'
                    }}
                >
